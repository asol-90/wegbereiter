...
const path = (d: string, extra?: Record<string, string | number>): React.ReactNode => (
  <path d={d} {...extra} />
)

const line = (x1: number, y1: number, x2: number, y2: number): React.ReactNode => (
...
const rect = (
  ...
  h: number,
  r = 1.5,
): React.ReactNode => <rect x={x} y={y} width={w} height={h} rx={r} />

const circle = (cx: number, cy: number, r: number): React.ReactNode => (
...
const ICONS: Record<IconName, IconDef> = {
  ...
  plus: { content: <>{line(12, 5, 12, 19)}{line(5, 12, 19, 12)}</> },
  minus: { content: <>{line(5, 12, 19, 12)}</> },
  x: { content: <>{line(6, 6, 18, 18)}{line(18, 6, 6, 18)}</> },
  check: { content: path('M5 12l4 4L19 6') },
  'chevron-down': { content: path('M6 9l6 6 6-6') },
  'chevron-up': { content: path('M6 15l6-6 6 6') },
  'chevron-right': { content: path('M9 6l6 6-6 6') },
  'chevron-left': { content: path('M15 6l-6 6 6 6') },
  search: {
    content: (
      <>
        {circle(11, 11, 7)}
  ...
  'link-open': {
    content: (
      <>
        {/* Two hook halves pulled apart, with small "snap" strokes indicating
            the broken chain. Mirrors the closed "link" glyph above. */}
        {path(
          'M18.84 12.25l1.72-1.71a5 5 0 00-.12-7.07 5 5 0 00-6.95 0l-1.72 1.71',
        )}
        {path(
          'M5.17 11.75l-1.71 1.71a5 5 0 00.12 7.07 5 5 0 006.95 0l1.71-1.71',
        )}
        {line(8, 2, 8, 5)}
        {line(2, 8, 5, 8)}
        {line(16, 19, 16, 22)}
  ...
  edit: {
    content: (
      <>
        {path('M17 3a2.83 2.83 0 114 4L7.5 20.5 2 22l1.5-5.5z')}
      </>
    ),
  },
  preset: {
    content: (
      <>
        {path('M12 2l2.4 7.2H22l-6 4.8 2.4 7.2L12 16.4l-6.4 4.8L8 14 2 9.2h7.6z')}
      </>
    ),
  },
  layers: {
  ...
  zap: {
    content: path('M13 2L3 14h9l-1 8 10-12h-9l1-8'),
  },
  tool: {
    content: (
      <>
  ...
  flame: {
    content: path('M12 22c4-2.5 7-6 7-10a7 7 0 00-14 0c0 4 3 7.5 7 10zM12 13a2.5 2.5 0 100-5 2.5 2.5 0 000 5z'),
  },
  compass: {
    content: (
      <>
  ...
  heart: {
    content: path('M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78L12 21.23l8.84-8.84a5.5 5.5 0 000-7.78z'),
  },
  sun: {
    content: (
      <>
  ...
  'award': {
    content: (
      <>
        {circle(12, 8, 6)}
        {path('M8.21 13.89L7 23l5-3 5 3-1.21-9.12')}
      </>
    ),
  },
  'book-open': {
